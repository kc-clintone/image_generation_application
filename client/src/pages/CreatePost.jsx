		...
		<section className='max-w-7xl mx-auto'>
			<div>
				...
				<p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>
					...
					artificial image generator and share with others on the community
				</p>
			</div>
			...
			<form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
				<div className='flex flex-col gap-5'>
					<FormField
						labelName='If you dont have an account, create an alias name.'
						type='text'
						name='name'
					...
					<FormField
						labelName='Type a description of an image you want bellow, or use the surprise me button to generate something random.'
						type='text'
						name='prompt'
